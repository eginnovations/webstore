...
<!--      <link href="https://fonts.googleapis.com/css?family=Lato:400,400i,700,900&display=swap" rel="stylesheet"> -->
   ...
   <script>
	function generateLoad(){
		...
		document.getElementById('cpu-looping').innerHTML = "<div style='display:inline-block'>"+ "Slowness Code IN-PROGRESS ...." + "</div>";
		
		var url = "productController/getProduct";
...
<form class="form-signin">
  ...
  <div class="form-label-group">
	...
	<div class="form-label-group">
		<div class="loading" id="cpu-looping" style="display:none">Java Slowness IN-PROGRESS .... </div>
	</div>
	<div class="form-label-group">
		<div class="noloading" id="cpu-done" style="display:none"><div class='tick' style='display:inline-block'></div>Java Slowness Scenario FINISHED !!! </div>
	</div>
