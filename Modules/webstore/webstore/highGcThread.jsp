...
<!--      <link href="https://fonts.googleapis.com/css?family=Lato:400,400i,700,900&display=swap" rel="stylesheet"> -->
   ...
   <script>
	function generateLoad(){
		...
		document.getElementById('cpu-looping').innerHTML = "<div style='display:inline-block'>"+ "High GC IN-PROGRESS ...." + "</div>";
		
		var url = "GCScenario/highgc?action=GCThread";
		...
		request.onreadystatechange = function() {
			...
			if (this.readyState === 4 && this.status === 200) {
				...
				document.getElementById('cpu-looping').innerHTML = "<div style='display:inline-block'><div class='tick' style='display:inline-block'></div>"+ "High GC Generation Finished !!!" + "</div>";
...
<form class="form-signin">
  ...
  <div class="form-label-group">
	...
	<div class="form-label-group">
		<div class="loading" id="cpu-looping" style="display:none">High GC IN-PROGRESS .... </div>
	</div>
	<div class="form-label-group">
		<div class="noloading" id="cpu-done" style="display:none"><div class='tick' style='display:inline-block'></div>High GC Scenario FINISHED !!! </div>
	</div>
