	...
	<script language="javascript">
		function callSynchronousAjax() {
			...
			while(counter<loopNum){
				...
				xhr.open("GET", "addressvalidationservice?sleepTime=1&downloadBytes=0", true);
				xhr.send(null);
				counter=counter+1;
			}
			alert(loopNum+" ASynchronous Ajax call sent successfully");
		}
	</script>
		...
		<div>
			<form class="form-signin">
			  <div class="text-left mb-4">   
					...
					<h1 class="h3 mb-3 font-weight-normal">ASynchronous Ajax Call</h1>
			  </div>
			</form>
		</div>
