...
<!--      <link href="https://fonts.googleapis.com/css?family=Lato:400,400i,700,900&display=swap" rel="stylesheet"> -->
	...
	<script language="javascript">
		function callSynchronousAjax() {
		  ...
		  xhr.open("GET", "addressvalidationservice?sleepTime=3&downloadBytes=500000", false);
		  xhr.open("GET", "addressvalidationservice?sleepTime=3&downloadBytes=500000", true);
		  alert("Synchronous Ajax call sent successfully");
		  xhr.send(null);
		}
	</script>
