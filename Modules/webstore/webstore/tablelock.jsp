...
<!--      <link href="https://fonts.googleapis.com/css?family=Lato:400,400i,700,900&display=swap" rel="stylesheet"> -->
   ...
   <script>
	...
	function generateLock(){
		...
		var url = "webstoreLock";
		request.open("GET",encodeURI(url));
		request.onreadystatechange = function() {
			if (this.readyState === 4 && this.status === 200) {
				resData = resData.concat(xhr.responseText+"<br>");
				document.getElementById("idd").innerHTML=resData;
			}
		}
		request.send();
	}
...
<form class="form-signin">
  <div class="text-left mb-4">
    ...
    <h1 class="h3 mb-2 font-weight-normal">Generate Table Lock</h1>
  </div>
	<button  id="generatecpu" name="generatecpu" class="btn btn-lg btn-primary btn-block" type="button" onclick="javascript:generateLock()">Lock</button>
	<button  id="generatecpu" name="generatecpu" class="btn btn-lg btn-primary btn-block" type="button" onclick="javascript:generateUnlock()">Unlock</button>
</form>
</div>
