...
<!--      <link href="https://fonts.googleapis.com/css?family=Lato:400,400i,700,900&display=swap" rel="stylesheet"> -->
   ...
   <script>
	function generateLoad(){
		...
		document.getElementById('cpu-looping').innerHTML = "<div style='display:inline-block'>"+ "Sending Customer Details IN-PROGRESS ...." + "</div>";
		
		var url = "CustomerAction/getCustomerDetails?count="+duration;
		...
		request.onreadystatechange = function() {
			...
			if (this.readyState === 4 && this.status === 200) {
				...
				document.getElementById('cpu-looping').innerHTML = "<div style='display:inline-block'><div class='tick' style='display:inline-block'></div>"+ "Sending Customer Details Generation Finished !!!" + "</div>";
...
<form class="form-signin">
  <div class="text-left mb-4">
    ...
    <h1 class="h3 mb-2 font-weight-normal">DB Connections Exhausted</h1>
    <p>Enter Number of Connection to Hold</p>
  </div>
  ...
  <div class="form-label-group">
	...
	<div class="form-label-group">
		<div class="loading" id="cpu-looping" style="display:none">Sending Customer Details IN-PROGRESS .... </div>
	</div>
	<div class="form-label-group">
		<div class="noloading" id="cpu-done" style="display:none"><div class='tick' style='display:inline-block'></div>Sending Customer Details Finished !!! </div>
	</div>
