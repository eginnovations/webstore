...
<!--      <link href="https://fonts.googleapis.com/css?family=Lato:400,400i,700,900&display=swap" rel="stylesheet"> -->
   ...
   <script>
	function generateLoad(){
		...
		document.getElementById('cpu-looping').innerHTML = "<div style='display:inline-block'>"+ "Looping IN-PROGRESS ...." + "</div>";
		
		var url = "CustomActionController?duration="+duration;
		...
		request.onreadystatechange = function() {
			...
			if (this.readyState === 4 && this.status === 200) {
				...
				document.getElementById('cpu-looping').innerHTML = "<div style='display:inline-block'><div class='tick' style='display:inline-block'></div>"+ "Looping FINISHED !!!" + "</div>";
...
<form class="form-signin">
  ...
  <div class="form-label-group">
    ...
    <label for="loopSec">Seconds</label>
  </div>
	<div class="form-label-group">
		<div class="loading" id="cpu-looping" style="display:none">Looping IN-PROGRESS .... </div>
	</div>
	<div class="form-label-group">
		<div class="noloading" id="cpu-done" style="display:none"><div class='tick' style='display:inline-block'></div>Looping FINISHED !!! </div>
	</div>
